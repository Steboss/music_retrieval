...
mfcc_components = 20
mfcc_matrix = mfcc.play(signal, rate , windowSize, hopSize, mfcc_components)
print(mfcc_matrix)
print("Done")

print("Test 2")
inputFile = "input_songs/sonata.mp3"
...
mfcc_matrix = mfcc.play(signal, rate , windowSize, hopSize, 20)
#print(max(frequencies))
print(mfcc_matrix.shape, mfcc_matrix.max(), mfcc_matrix.min())
print("Done")
sys.exit(-1)
